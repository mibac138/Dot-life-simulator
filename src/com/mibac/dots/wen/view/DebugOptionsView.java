...
public class DebugOptionsView extends JFrame implements ActionListener {
    ...
    public DebugOptionsView() {
        ...
        debug.setSelected(DEBUG.isEnabled());
